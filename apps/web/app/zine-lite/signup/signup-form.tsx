...
export const ZineLiteSignupForm = () => {
    ...
    return (
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            <button type="button" onClick={() => signIn("google", { callbackUrl: `/${creatorHandle}/content` })}
            ...
            <label className="block text-sm">
                ...
                <div className="relative">
                    <input type={showPassword ? "text" : "password"} placeholder="8文字以上" className={clsx("w-full rounded-2xl border bg-black px-4 py-3 pr-12 text-sm text-white placeholder:text-white/40 focus:border-green-400 focus:outline-none", errors.password ? "border-red-500" : "border-white/10")} {...register("password")} />
            ...
            <label className="block text-sm">
                ...
                <div className="relative">
                    <input type={showConfirmPassword ? "text" : "password"} placeholder="もう一度入力" className={clsx("w-full rounded-2xl border bg-black px-4 py-3 pr-12 text-sm text-white placeholder:text-white/40 focus:border-green-400 focus:outline-none", errors.confirmPassword ? "border-red-500" : "border-white/10")} {...register("confirmPassword")} />
