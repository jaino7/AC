        ...
        <div className="min-h-screen bg-black text-white">
                ...
                <section className="mt-8 rounded-[24px] border border-white/10 bg-[#111111] p-8">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-4xl font-bold text-green-400">¥{credits.toLocaleString()}</p>
                        </div>
                        <button
            ...
            {showChargeModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
                    <div className="w-full max-w-md rounded-[24px] bg-[#111111] border border-white/10 p-8">
                        {!chargeResult ? (
                            <>
                                ...
                                <div className="mt-6">
                                    ...
                                    <input
                                        ...
                                        placeholder="10000"
                                        className="mt-2 w-full rounded-xl border border-white/10 bg-black px-4 py-3 focus:border-green-400 focus:outline-none"
                                    />
                                </div>
                                <div className="mt-6 flex gap-3">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 rounded-full bg-gradient-to-r from-green-400 to-emerald-500 px-6 py-3 text-sm font-semibold text-black hover:opacity-90"
                                    >
                                        申請する
                                    </button>
                                </div>
                            ...
                            <>
                                <h3 className="text-xl font-semibold text-green-400">申請完了</h3>
                                <div className="mt-4 rounded-xl bg-black border border-white/10 p-4">
                                    ...
                                    <div className="mt-4 rounded-lg bg-green-400/10 p-3">
                                        <p className="text-xs font-semibold text-green-400">識別コード</p>
                                        <p className="text-lg font-bold text-green-400">{chargeResult.identifierCode}</p>
                                ...
                                <button
                                    ...
                                    className="mt-6 w-full rounded-full bg-gradient-to-r from-green-400 to-emerald-500 px-6 py-3 text-sm font-semibold text-black"
                                >
                                    閉じる
                                </button>
                            </>
