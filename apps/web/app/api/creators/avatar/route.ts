...
export async function POST(request: NextRequest) {
    try {
        ...
        const r2Key = `uploads/avatars/${filename}`;
        ...
        if (hasR2Config) {
            ...
            avatarUrl = `${publicUrl}/${r2Key}`;
            console.log("[R2 AVATAR] Uploaded to R2:", avatarUrl);
        } else {
            ...
            console.log("[LOCAL AVATAR] Saved locally:", avatarUrl);
        }
