...
import { PureLiteAccountForm } from "./account-form";
        ...
        <section className="mt-6 rounded-[30px] border border-black/5 bg-white p-8 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="h-16 w-16 rounded-full bg-[#fde4d2] overflow-hidden flex items-center justify-center">
                {imagePreview ? (
              ...
              <div>
                ...
                <p className="text-sm text-[#8d8d9a]">新しいプロフィール画像をアップロードします。</p>
              </div>
            </div>
            <div className="relative">
              <input
              ...
              <button
                ...
                className="rounded-full bg-[#f1f1f6] px-4 py-2 text-sm font-semibold hover:bg-[#e4e4e9]"
              >
                画像をアップロード
              </button>
            </div>
