...
export default function PureLiteContentDetailPage() {
    ...
    const { data, isLoading, refetch } = useQuery({
        queryKey: ["content-detail", "pure-lite", id],
        queryFn: async () => {
        ...
        <div className="min-h-screen bg-[#fafafa]">
            ...
            <header className="border-b border-gray-200 bg-white px-6 py-4">
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className="mt-4">
                        <p className="text-sm text-gray-500">{creator.displayName}</p>
                ...
                <div className="grid gap-8 lg:grid-cols-[1fr,400px]">
                    ...
                    <div className="space-y-6">
                        ...
                        {mainMedia.length > 0 && !hasAccess && (
                            <div className="rounded-2xl border border-purple-200 bg-gradient-to-br from-purple-50 to-purple-100 p-8 text-center">
                                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-purple-200 mb-4">
                                ...
                                {post.requiredPlan ? (
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-purple-500 px-8 py-3 font-semibold text-white hover:from-purple-700 hover:to-purple-600 transition shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-4">
                                    {mainMedia.map((media, index) => (
                                        <div key={media.id} className="rounded-2xl overflow-hidden bg-white border border-gray-200 shadow-sm">
                                            {media.type === "VIDEO" ? (
                                                <video
                                                    src={media.url}
                                                    controls
                            ...
                            <dl className="space-y-3 text-sm">
                                ...
                                {(() => {
                                    ...
                                    return images.length > 0 && (
                                        <div>
                                            <dt className="text-gray-500">画像</dt>
                                            <dd className="text-gray-900 font-medium">{images.length}枚</dd>
                                        </div>
                                    );
                                })()}
                            </dl>
