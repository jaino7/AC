            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="space-y-6 text-gray-700">
                    ...
                    <section>
                        ...
                        <p>
                            当運営は、ユーザーが利用登録をする際に氏名、生年月日、住所、電話番号、メールアドレス、<strong>銀行口座番号（報酬の支払いや本人確認のため）</strong>、身分証明書等の個人情報を尋ねることがあります。また、お問い合わせフォームを通じて、お名前、メールアドレス、お問い合わせ内容等の情報を収集することがあります。
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ol className="list-decimal space-y-2 pl-6">
                            ...
                            <li>サービス品質向上および運営管理のため（お問い合わせ内容の管理・共有を含む）</li>
                        </ol>
                    </section>
                    ...
                    <section>
                        ...
                        <ol className="list-decimal space-y-2 pl-6">
                            ...
                            <li>銀行の仮想口座システム等、本サービスの提供に必要な外部サービスを利用する場合</li>
                            <li>お問い合わせ管理のため、外部通知サービス（Discord等）を利用する場合</li>
                        </ol>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="rounded-lg bg-gray-50 p-4 space-y-2">
                            <p><strong>氏名：</strong>CocoBa運営事務局</p>
                            <p><strong>Eメールアドレス：</strong>ownstage3m@gmail.com</p>
                            <p><strong>お問い合わせフォーム：</strong><a href="/contact" className="text-blue-600 hover:underline">/contact</a></p>
                        </div>
                    </section>
