...
export default function StudioProContentDetailPage() {
    ...
    const { data, isLoading, refetch } = useQuery({
        queryKey: ["content-detail", "studio-pro", id],
        queryFn: async () => {
            ...
            <main className="mx-auto max-w-5xl px-6 py-8">
                <div className="grid gap-8 lg:grid-cols-[1fr,400px]">
                    ...
                    <div className="space-y-6">
                        ...
                        {sampleMedia.length > 0 && (
                            <div className="space-y-4">
                                ...
                                {/* メディア表示 */}
                                <div className="rounded-xl overflow-hidden bg-[#13171f] border border-white/10">
                                    ...
                                    <div className="flex gap-3 overflow-x-auto pb-2">
                                        {sampleMedia.map((media, index) => (
                                            <button
                                                ...
                                                className={`flex-shrink-0 w-24 h-24 rounded-lg overflow-hidden border-2 transition ${selectedSampleIndex === index
                                                    ? "border-blue-500"
                        ...
                        {mainMedia.length > 0 && !hasAccess && (
                            <div className="rounded-xl border border-blue-500/30 bg-gradient-to-br from-blue-600/10 to-purple-600/10 p-8 text-center">
                                ...
                                {!isLoggedIn ? (
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-8 py-3 font-semibold text-white hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid gap-4">
                                    {mainMedia.map((media, index) => (
                                        <div key={media.id} className="rounded-xl overflow-hidden bg-[#13171f] border border-white/10">
                                            {media.type === "VIDEO" ? (
                                                <video
                                                    src={media.url}
                                                    controls
                    ...
                    <aside className="space-y-6">
                        {/* 投稿情報 */}
                        <div className="rounded-xl border border-white/10 bg-[#13171f] p-6">
