                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div className={`relative rounded-2xl border-2 p-5 transition-all ${isCurrent
                                                        ...
                                                        <p className="mt-2 text-xs text-neutral-600">手数料率: {subscription?.plan?.type === "FREE" ? (subscription.plan.feeRate < 1 ? subscription.plan.feeRate * 100 : subscription.plan.feeRate) : 10}%</p>
