            ...
            <div className="space-y-8">
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.05)]">
                        <p className="text-sm text-neutral-500">アクティブファン</p>
                        <p className="mt-2 text-4xl font-semibold">1,204</p>
                    </div>
                    <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.05)]">
                        <p className="text-sm text-neutral-500">今月の新規ファン</p>
                        <div className="mt-2 flex items-baseline gap-3">
                            <p className="text-4xl font-semibold">82</p>
                            <span className="text-sm font-semibold text-green-600">+71%</span>
                        </div>
                    </div>
                    <div className="rounded-3xl border border-black/10 bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.05)]">
                        <p className="text-sm text-neutral-500">エラー/解約</p>
                                ...
                                {fans.map((fan) => (
                                    <tr key={fan.id} className="transition-colors hover:bg-neutral-50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-2">
                                                <span
                                                    className={`h-2 w-2 rounded-full ${fan.status === "アクティブ"
                                                            ? "bg-green-500"
                                                            : fan.status === "決済失敗"
                                                                ? "bg-red-500"
                                                                : "bg-neutral-400"
